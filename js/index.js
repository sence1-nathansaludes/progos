...
window.onload = function () {
  $("footer .container-1 .group-1 .tab-content").html(
    $("footer .container-1 .group-1 .accordion .accordion-item.active .content").html()
  );
};

$("footer .container-1 .group-1 .accordion .accordion-item").click(function () {
  if ($(this).hasClass("active")) {
    $("footer .container-1 .group-1 .tab-content")
      .removeClass("active")
      .html("");
    $("footer .container-1 .group-1 .accordion .accordion-item.active").toggleClass("active");
  } else {
    ...
    $("footer .container-1 .group-1 .accordion .accordion-item.active").removeClass("active");
